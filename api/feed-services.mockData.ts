...
export const FEED_DETAILS_DATA: { feed: FeedItemType[] } = {
  feed: [
    {
      id: "c9568bdf-dec9-4a78-802c-0d175fdca1e1",
      promotionId: "1680cacc-17d1-46ee-a1fa-1c90d65d6f2d",
      campaignId: "026812ff-7046-4650-9e18-c9893c354b11",
      image: {
        id: "026812ff-7046-4650-9e18-c9893c3img01",
        source: { uri: ImageUris.placeholder },
        dimensions: { height: 435 },
      },
      user: {
    ...
    {
      id: "c9568bdf-dec9-4a78-802c-0d175fdca1e2",
      promotionId: "1680cacc-17d1-46ee-a1fa-1c90d65d6f2d",
      campaignId: "026812ff-7046-4650-9e18-c9893c354b11",
      image: {
        id: "026812ff-7046-4650-9e18-c9893c3img02",
        source: { uri: ImageUris.placeholder },
        dimensions: { height: 300 },
      },
      user: {
    ...
    {
      id: "c9568bdf-dec9-4a78-802c-0d175fdca1e3",
      promotionId: "1680cacc-17d1-46ee-a1fa-1c90d65d6f2d",
      campaignId: "026812ff-7046-4650-9e18-c9893c354b11",
      image: {
        id: "026812ff-7046-4650-9e18-c9893c3img03",
        source: { uri: ImageUris.placeholder },
        dimensions: { height: 435 },
      },
      user: {
