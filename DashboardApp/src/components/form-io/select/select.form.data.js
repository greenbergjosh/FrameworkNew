import { eachComponent } from "formiojs"
...
export default [
  {
    ...
    data: {
      values: [
        ...
        { label: "Query Result", value: "query" },
  ...
  //   input: true,
  //   key: "data.json2",
  //   label: "A raw JSON array to use as a data source",
  ...
  },
  {
    ...
    tooltip: "The query to run that will provide selectable values",
    conditional: {
      json: { "===": [{ var: "data.dataSrc" }, "query"] },
    },
  },
  {
    type: "datagrid",
