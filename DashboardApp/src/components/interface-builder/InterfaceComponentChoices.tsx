  ...
  return (
    <div>
      <Collapse accordion defaultActiveKey={["Form"]}>
        {Object.entries(sortedGroupedComponents(componentRegistry.cache)).map(
          ([category, layoutDefinitions]) => (
...
function sortedGroupedComponents(
  componentRegistry: ComponentRegistryCache
): Dictionary<LayoutDefinition[]> {
  return groupBy(
