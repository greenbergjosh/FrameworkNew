...
namespace DataLayerExtensions
{
    public static class DataTableExtensions
    {
        ...
        {
            CakeIntegration.DataLayer.AddDataRow(dt, data);
        }
    }
}
...
namespace CakeIntegration
{
    public class DataLayer
    {
        ...
        static void PopulateInboxPass(string connectionString)
        {
            ...
            while (sdr.Read())
            {
                InboxPasswords.Add((int)sdr["Id"], new DataLayer.InboxPass()
                {
                    ...
                    AffiliateId = sdr["Affiliate Id"] != DBNull.Value ? (string)(sdr["Affiliate Id"]) : "",
        ...
        public static async Task InsertIpJobStatus(string evtConnectionString, string reportJobName, DateTime reportStartTime,
            ...
            string outputFileName, int inboxPassId, string errorOutput)
        {
        ...
        public static void ParseClickBoothClickXml(DataTable dt, int inboxPassId, XmlNodeList clickNodes)
        {
            DataRow dr = null;
        ...
        public static void ParseClickBoothConversionXml(DataTable dt, int inboxPassId, XmlNodeList conversionNodes)
        {
            DataRow dr = null;
            ...
            foreach (XmlNode clickNode in conversionNodes)
            {
                ...
                if (ipNode != null && ipNode.InnerText != null)
                {
                    dr["conversion_ip_address"] = ipNode.InnerText;
                }
        ...
        public static DataRow CsvReportDataRow(DataTable dt, int inboxPassId, string[] data, string type)
        {
            DataRow dr = null;
        ...
        public static DataRow CakeClickReportDataRowV9(DataTable dt, int inboxPassId, CakeIntegration.CakeV9.click c)
        {
            DataRow dr = dt.NewRow();
        ...
        public static DataRow CakeConversionReportDataRowV9(DataTable dt, int inboxPassId, CakeIntegration.CakeV9.event_conversion c)
        {
            DataRow dr = dt.NewRow();
        ...
        public static DataRow CakeClickReportDataRowV10(DataTable dt, int inboxPassId, CakeIntegration.CakeV10.click c)
        {
            DataRow dr = dt.NewRow();
        ...
        public static DataRow CakeConversionReportDataRowV10(DataTable dt, int inboxPassId, CakeIntegration.CakeV10.conversion c)
        {
            DataRow dr = dt.NewRow();
