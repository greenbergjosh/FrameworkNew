    ...
    <>
      ...
      <Layout.Content>
        ...
        <PageHeader
          ...
          subTitle={
            <span>
              To change the an example&rsquo;s interface, go to the <strong>Configure</strong> tab
              and then click the component&rsquo;s edit icon, or drag new components into the
              interface layout. When you are done, return to the <strong>Preview</strong> tab.
            </span>
          }
        />
