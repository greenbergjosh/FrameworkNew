...
export type FormatConj = (children: ImmutableList<string>, conj: string, not: boolean, isForDisplay?: boolean) => string;
export type SqlFormatConj = (children: ImmutableList<string>, conj: string, not: boolean) => string;
// RWB+Onpoint Mod
export type IsDisabled = (children: ImmutableList<string>, conjKey: string, not: boolean, opt: ConjunctionOption, selectedConjunction: string, setConjunction: (conjKey: string | null) => void) => boolean;
