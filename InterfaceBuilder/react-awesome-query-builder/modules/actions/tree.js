...
import {defaultRuleProperties, defaultGroupProperties, defaultFilterProperties} from "../utils/defaultUtils";
 ...
 * @param {Immutable.Map} properties
 */
export const addFilter = (config, path, properties) => ({
  type: constants.ADD_NEW_FILTER,
  path: path,
  properties: defaultFilterProperties().merge(properties || {}),
  config: config
});
 ...
 */
export const setFilterField = (config, path, fieldName) => ({
  type: constants.SET_FILTER_FIELD,
  config,
  path,
  fieldName,
});
