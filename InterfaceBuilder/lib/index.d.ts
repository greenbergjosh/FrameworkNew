...
export { CodeEditor, editorLanguages, EditorLangCodec, registerMonacoEditorMount, } from "./components/interface-builder/components/special/code-editor/code-editor";
 ...
 */
export declare type ComponentDefinition = _ComponentDefinition;
export declare type ComponentDefinitionNamedProps = _ComponentDefinitionNamedProps;
export declare type ComponentRenderMetaProps = _ComponentRenderMetaProps;
export declare type FormInterfaceComponentProps = _FormInterfaceComponentProps;
export declare type JSONRecord = _JSONRecord;
export declare type TSEnum<T extends string | undefined> = _TSEnum<T>;
export declare type UserInterfaceContextManager<T> = _UserInterfaceContextManager<T>;
export declare type UserInterfaceProps = _UserInterfaceProps;
