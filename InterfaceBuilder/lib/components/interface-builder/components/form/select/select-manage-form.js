        ...
        components: [
            {
                ...
                tabs: [
                    {
                        key: "data",
                        components: __spread(selectable_1.baseSelectDataComponents.slice(0, 3), [
                            {
                                key: "multiple",
                                valueKey: "multiple",
                        ...
                        ], selectable_1.baseSelectDataComponents.slice(3)),
                    },
                    {
                        key: "appearance",
                        components: [
...
exports.selectManageForm = function () {
    var extend = [];
...
//# sourceMappingURL=select-manage-form.js.map