...
import { ComponentModifierPropsOLD } from "components/RenderComponents/types"

interface EditPanelWrapperProps extends ComponentModifierPropsOLD, Omit<EditPanelWithToolsProps, "draggableItem"> {
