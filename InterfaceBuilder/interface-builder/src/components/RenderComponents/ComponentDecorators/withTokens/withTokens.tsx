...
export const withTokens: ComposableFn<React.ComponentType<ComponentModifierProps>> = (Wrapper) => {
  const _withTokens = (hocProps: ComponentModifierProps) => {
    /**
    ...
    const tokenReplacedComponentDefinition = React.useMemo(() => {
      ...
      return newDef
    }, [hocProps.componentDefinition, hocProps.userInterfaceData, hocProps.mode, hocProps.getRootUserInterfaceData])
