...
namespace NewLighthouseFtpLib
{
    public class Utility
    {
        ...
        public static void UnzipZip(FileInfo fi)
        {
            try
            {
                ...
                _processStartInfo.WorkingDirectory = baseDir;
                _processStartInfo.FileName = "C:\\Program Files\\Git\\usr\\bin\\unzip";
                _processStartInfo.Arguments = fi.FullName;
