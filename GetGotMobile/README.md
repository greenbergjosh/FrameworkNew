...
There is also a companion project in this same repo called GetGotWeb that contains a web server which provides additional functionality for the mobile apps.
