...
namespace Framework.Core.CodeProviders
{
    ...
    {
        private static ConcurrentDictionary<string, Func<Request, DictionaryStack, Task<IDictionary<string, object>>>> _cache = new ConcurrentDictionary<string, Func<Request, DictionaryStack, Task<IDictionary<string, object>>>>();

        public Func<Request, DictionaryStack, Task<IDictionary<string, object>>> GetEvaluate(IDictionary<string, object> evaluateConfiguration)
        {
            return _cache.GetOrAdd(evaluateConfiguration.Get<string>("Implementation"), _ =>
            {
