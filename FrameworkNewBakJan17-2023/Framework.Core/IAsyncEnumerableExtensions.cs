namespace System.Collections.Generic
{
    public static class IAsyncEnumerableExtensions
    {
        ...
        public static Task<Dictionary<TKey, TSource>> ToDictionary<TSource, TKey>(this IAsyncEnumerable<TSource> source, Func<TSource, Task<TKey>> keySelector) where TKey : notnull => ToDictionary(source, keySelector, x => Task.FromResult(x));
