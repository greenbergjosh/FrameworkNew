...
namespace SeleniumSandbox
{
    public class SqlWrapper
    {
        public static async Task<string> SqlServerProviderEntry(string conStr, string method, string args, string payload)
        {
            ...
            {//[dbo].[spInsertDomainDeliveryError]
                { "SelectConfig" , "[dbo].[spSelectConfig]" },
                { "SelectPostmasterAccounts", "[dbo].[spSelectPostmasterAccounts]" },
                { "InsertIpStatus", "[dbo].[spInsertIpStatus]" },
                { "InsertData", "[dbo].[spInsertData]" },
                { "SelectIps", "[dbo].[spSelectIps]" },
                { "InsertBlacklist", "[dbo].[spInsertBlacklist]" },
                { "InsertGmailDomainStatus", "[dbo].[spInsertGmailDomainStatus]" },
                { "InsertDomainSpamRate", "[dbo].[spInsertDomainSpamRate]" },
                { "InsertDomainIpReputation", "[dbo].[spInsertDomainIpReputation]" },
                { "InsertDomainReputation", "[dbo].[spInsertDomainReputation]" },
                { "InsertDomainFeedbackLoop", "[dbo].[spInsertDomainFeedbackLoop]" },
                { "InsertDomainAuth", "[dbo].[spInsertDomainAuth]" },
                { "InsertDomainEncryption", "[dbo].[spInsertDomainEncryption]" },
                { "InsertDomainDeliveryError", "[dbo].[spInsertDomainDeliveryError]" }
            };
