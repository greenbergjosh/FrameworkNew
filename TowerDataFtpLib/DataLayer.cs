...
namespace DataLayerExtensions
{
    public static class DataTableExtensions
    {
        ...
        {
            TowerDataFtpLib.DataLayer.AddDataRow(dt, data);
        }
    }
}
...
namespace TowerDataFtpLib
{
    ...
    {     
        ...
        public static async Task<bool> AlreadyDownloaded(string connectionString, string fileName)
        {
            ...
            SqlDataReader sdr;
            SqlCommand cmd = cn.CreateCommand();
            cmd.CommandText = "TowerData.AlreadyDownloaded";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static async Task<DateTime> GetMaxEndDayProvidedToThirdParty(string connectionString, string host, int port, string username)
        {
            ...
            SqlDataReader sdr;
            SqlCommand cmd = cn.CreateCommand();
            cmd.CommandText = "TowerData.GetMaxEndDayProvidedToThirdParty";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static async Task<DateTime> GetMaxDateFtpFileProcessed(string connectionString)
        {
            ...
            SqlDataReader sdr;
            SqlCommand cmd = cn.CreateCommand();
            cmd.CommandText = "TowerData.GetMaxDateFtpFileProcessed";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static async Task InsertProcessedFtpFile(string connectionString, string fileName, DateTime fileDate, DateTime startDate, DateTime endDate, long recordsInFile, long recordsAddedFromFile)
        {
            SqlConnection cn = new SqlConnection(connectionString);
            cn.Open();
            SqlCommand cmd = cn.CreateCommand();
            cmd.CommandText = "[TowerData].[InsertProcessedFtpFile]";
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            DateTime startDayProvidedToThirdParty, DateTime endDayProvidedToThirdParty, string host, int port, string username, int delayInDays)
        {
            ...
            cn.Open();
            SqlCommand cmd = cn.CreateCommand();
            cmd.CommandText = "[TowerData].[InsertThirdPartyExportLog]";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static async Task InsertIntoContactAndDataByEmail(string connectionString)
        {
            try
            {
                await DataLayer.InsertErrorLog(connectionString, 1, "TowerDataFtpImporter", "DoImport", "[TowerData].[InsertIntoContactAndDataByEmail]",
                                "Called from code");

                SqlConnection cn = new SqlConnection(connectionString);
                cn.Open();
                SqlCommand cmd = cn.CreateCommand();
                cmd.CommandText = "[TowerData].[InsertIntoContactAndDataByEmail]";
                cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                await DataLayer.InsertErrorLog(connectionString, 100, "TowerDataFtpImporter", "DoImport", "Failed to run [InsertIntoContactAndDataByEmail]",
                                ex.ToString());
            }
